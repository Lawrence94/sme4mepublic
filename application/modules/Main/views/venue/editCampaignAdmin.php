...
<li><a href="<?= site_url('company/Venues/venueDetailsCamp/'.$venueId) ?>" class="active">Venue Details</a></li>
<li><a href="#" class="active">Edit Campaign</a> </li>
</ul>
<div class="page-title"> <a href="<?= site_url('company/Venues/venueDetailsCamp/'.$venueId) ?>" class="active"><i class="icon-custom-left"></i></a>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="grid simple">
                ...
                ?>
                <div class="grid-body no-border">
				              <form id="admin_formm" name="adminform" class="animated" action="<?= site_url('company/Venues/editCamp/'. $value['id'].'/'. $venueId) ?>" method="post">
                          <div class="row form-row">
                            <div class="col-md-6">
